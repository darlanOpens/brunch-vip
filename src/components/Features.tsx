...
export default function Features() {
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-12 md:gap-[83px] items-center justify-start overflow-clip pb-10 md:pb-[61px] pt-12 md:pt-[73px] px-4 md:px-[108px] relative shrink-0 w-full">
      ...
      <div className="relative shrink-0 w-full mb-10 md:mb-12">
          <div className="box-border content-stretch flex flex-col md:flex-row gap-8 md:gap-14 items-center justify-start overflow-hidden p-6 md:p-[56px] relative w-full border border-[#343434] rounded-xl">
            <div className="absolute size-[799px] top-1/2 translate-x-[-50%] translate-y-[-50%] pointer-events-none" style={{ left: "calc(50% + 301.5px)" }}>
            ...
            <div className="box-border content-stretch flex flex-col gap-6 items-center justify-start p-0 relative shrink-0">
              <div className="box-border content-stretch flex flex-col gap-4 items-center justify-start leading-[0] p-0 relative shrink-0 text-[#ffffff] text-center w-full md:w-[546px]">
                ...
                <div className="flex flex-col font-['Work_Sans:Regular',_sans-serif] font-normal justify-center opacity-70 relative shrink-0 text-[16px] w-full">
                  <p className="block leading-[1.4]">
                    Este não é um evento para todos. É para quem está pronto para elevar o nível das suas conexões e do seu negócio.
                  </p>
                </div>
              </div>
              <div className="bg-[rgba(255,255,255,0.1)] box-border content-stretch flex flex-row gap-2 items-center justify-center px-4 py-2 relative shrink-0">
            ...
            <div className="absolute left-[715px] size-[970.885px] top-14 pointer-events-none">
